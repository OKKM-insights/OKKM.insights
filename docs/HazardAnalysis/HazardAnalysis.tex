...
\multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}Account \\ Creation\end{tabular}} &
  ...
  \begin{tabular}[c]{@{}l@{}}Notify the user that the email \\ is associated with another\\  account\\ \\ Prompt them to give another \\ email or sign in with the one \\ they entered\end{tabular} & 3 &
   SE2 &
  H1-1 \\ \cline{2-9} 
 &
  ...
  \begin{tabular}[c]{@{}l@{}}1) Notify the user that they must\\ enter a valid email and give an \\ example of a valid email\\ 2) Tell the user what password\\ requirements they have and \\ have not satisfied\end{tabular} & 3 &
   SE2,3 &
  H1-2 \\ \hline
\multirow{2}{*}{Log In} &
  ...
  \begin{tabular}[c]{@{}l@{}}1) Tell user account does not\\ exist and prompt them to \\ make one\\ 2) Tell user password is incorrect\\ and prompt password recovery\end{tabular} & 3 &
   SE0,1&
  H2-1 \\ \cline{2-9} 
 &
  ...
  \begin{tabular}[c]{@{}l@{}}Tell the user to log in\\ \\ Deny access if they try to \\ access a \\ page they should not\end{tabular} & 4 &
  SE0,1 &
  H2-2 \\ \hline
\multirow{4}{*}{\begin{tabular}[c]{@{}l@{}}Labeling \\ Satallite \\ Images\end{tabular}} &
  ...
  \begin{tabular}[c]{@{}l@{}}Any labeled photos or created \\ projects that have already been\\ submitted have been saved\\ \\ Progress is resumed when \\ connection is re-established\end{tabular} & 3 &
   SE4&
  H3-1 \\ \cline{2-9} 
 &
  ...
  \begin{tabular}[c]{@{}l@{}}Any labeled photos or created\\ projects that have already been\\ submitted have been saved\\ \\ Progress is resumed on log in\end{tabular} & 2 &
   SE4&
  H3-2 \\ \cline{2-9} 
 &
  ...
  \begin{tabular}[c]{@{}l@{}}Reject a submission if no \\ labeling was done\end{tabular} & 5 &
  SE5 & 
  H3-3 \\ \cline{2-9} 
 &
  ...
  \begin{tabular}[c]{@{}l@{}}Implement a submission cool \\ down to prevent \\ bot submissions \\ \\ Reward system is based \\ on accuracy\end{tabular} & 3 &
  SE5 &
  H3-4 \\ \hline
\multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}Backend \\ Server \\ and \\ API \\ Requests\end{tabular}} &
  ...
  Error found in logs &
  \begin{tabular}[c]{@{}l@{}}Monitor errors in logs\\ \\ Notify users that the \\ server is down\end{tabular} & 5 &
   SE6& 
  H4-1 \\ \cline{2-9} 
 &
  ...
  \begin{tabular}[c]{@{}l@{}}Retry all API requests after a \\ specific amount of time\\ \\ Monitor errors in logs\end{tabular} & 5 &
   SE6& 
  H4-2 \\ \hline
\multirow{3}{*}{Data Storage} &
  ...
  \begin{tabular}[c]{@{}l@{}}Ensure user passwords are \\ encrpyted when stored\\ \\ Ensure financial transactions \\ are secure\\ \\ Password reset occurs \\ through a trusted \\ source such as email\end{tabular} & 4 &
   SE8,9 & 
  H5-1 \\ \cline{2-9} 
 &
  ...
  \begin{tabular}[c]{@{}l@{}}Ensure the database has \\ unique keys\\ \\ Set up a duplicate key \\ procedure on the\\ database\end{tabular} & 2 &
  SE7 & 
  H5-2 \\ \cline{2-9} 
 &
  ...
  \begin{tabular}[c]{@{}l@{}}Use parameterized queries\\ \\ Avoid dynamic SQL strings\end{tabular} & 5 &
  SE10 &
  H5-3 \\ \hline
