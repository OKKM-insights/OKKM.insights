...
\begin{enumerate}
    ...
    \textbf{Kyle:} As a team, we have a lot more experience working with eachother and assigning tasks based on expertise. This showed during this stage of the project. We were able to
    ...
    we unable to work much on this deliverable until midway through last week (with the exception of Mathew, who provided the team with the first iteration of the harzard table). If we 
    ...
    \textbf{Kyle:} As I discussed above, there was a real challenge for the team to allocate time towards this deliverable. The team had personal commitments over reading week
    ...
    did they come about?\\\\
    \textbf{Kyle:} We were aware of risks to the data integrity before this deliverable. We have been thinking to methods to ensure that users are rewarded for being consistently accurate.\\
    ...
    \textbf{Kyle:} A big risk is privacy. Users trust us to keep their personal information secure. In the past, the only way a malicious agent could collect so much personal data at one time 
