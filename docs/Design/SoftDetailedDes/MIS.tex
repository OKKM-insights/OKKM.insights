...
\subsection{Uses}
    ...
    ObjectsOnImageDBConnector \ref{ooidbc}\\
    RawImageDBConnector \ref{ridbc}\\
...
% OG
\section{MIS of Objects Database Connector} \label{ooidbc} 

% OG
\section{MIS of Image Database Connector} \label{ridbc} 
