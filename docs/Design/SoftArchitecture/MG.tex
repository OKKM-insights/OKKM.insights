...
\multirow{26}{0.3\textwidth}{Behaviour-Hiding Module} & Account Creation Interface\\
& Account Database\\
& Account Database Connector\\
& Account Update Interface\\
& Login Interface\\
...
\begin{tabular}{p{0.3\textwidth} p{0.6\textwidth}}
  ...
  \textbf{Level 1} & \textbf{Level 2}\\
  \midrule
\multirow{12}{0.3\textwidth}{Software Decision Module} & {Account Creation Controller}\\
& Account Update Controller\\
& Authentication Controller\\
& Satellite Image Request Controller\\
& Project Creation Controller\\
