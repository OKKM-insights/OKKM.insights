...
\subsubsection{Label Database Connector}
\begin{description}
...
\subsubsection{ImageObject Database Connector}
\begin{description}
\item[Secrets:] The steps to connect to and manipulate a database.
\item[Services:] Connects to a database and executes pushing and fetching of data.
\item[Implemented By:] [Your Program Name Here]
...
\subsubsection{ImageObject Database}
\begin{description}
\item[Secrets:] The storing and retrieving of data.
\item[Services:] Allows connection by a database connector to facilitate the storage and retreival of data.
\item[Implemented By:] [Your Program Name Here]
...
\subsubsection{Labeller Database Connector}
\begin{description}
\item[Secrets:] The steps to connect to and manipulate a database.
\item[Services:] Connects to a database and executes pushing and fetching of data.
\item[Implemented By:] [Your Program Name Here]
...
\subsubsection{Labeller Database}
\begin{description}
\item[Secrets:] The storing and retrieving of data.
\item[Services:] Allows connection by a database connector to facilitate the storage and retreival of data.
\item[Implemented By:] [Your Program Name Here]
...
\subsubsection{Object Extraction Manager}
\begin{description}
...
\subsubsection{Image Service Manager}
\begin{description}
...
\subsubsection{Label Confidence Service}
\begin{description}
...
\subsubsection{Object Extraction Service}
\begin{description}
...
\subsubsection{Image Prior Analyzer}
\begin{description}
...
\subsubsection{Labeller Expertise Calculator}
\begin{description}
...
\subsubsection{Image Mask Service}
\begin{description}
...
\subsubsection{Image Selection Service}
\begin{description}
