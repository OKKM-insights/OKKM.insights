...
\begin{enumerate}
    ...
    we were having, and dicuss what our overall mission is. Almost more importantly though, working on this document (and problem statement/goals)
    was a sort of dry run for future deliverables. As we worked on this doc, we were able to put our plans of how we thought we would work together to the test. We found 
