...
\begin{table}[H]
  ...
  \begin{tabular}{|p{3cm}|p{6cm}|p{3cm}|}
    ...
    \cline{1-2} 
    Kyle McMaster & Meeting Chair, Back-End Development Expert  & \\
    \cline{1-2}
...
\begin{itemize}
  ...
  maintaining respectful and concise communication. The role of meeting note taker will rotate among members in each meeting. The note taker should keep track of meeting attendance,
   issues discussed, decisions made, and action items. These notes should be well-maintained and easily accessible to all team members.
    ...
    Also responsible for assisting team members with the application's back-end logic and deploying services.
...
We intend to work hard to make a project we are very proud of. We all expect this effort will translate into an A+ in the course, although this is somewhat
...
\item If attendance is not possible, they will notify the team at least 24 hours in advance. Each team member will be permitted to have 2 absences per semester 
...
Each addition to the project should be crafted with high attention to detail, and reviewed throughly by the creator.
...
This reviewer will approach the review as if they are the last line of defense for the quality of the code.\\\\
Every team member will complete expected action items and review the provided agenda before each meeting.
...
\item Team members will answer questions and provide additional information to team members who are interested in developing skills they are proficient In
\item We will be kind
\end{itemize}
...
discuss progress and blockers. This will ensure there are no surprises when a deadline is approaching. We will also define internal deadlines to provide enough
...
also important to the team, but a little less so. As long as we are able to find one person to attend, we will not worry much about lecture attendance. We will 
be sure to track lecture attendance so if we need to force someone to attend, we can choose the person with worst attendance.
...
After a large deliverable, the team has agreed to celebrate at a location of their choosing. 
