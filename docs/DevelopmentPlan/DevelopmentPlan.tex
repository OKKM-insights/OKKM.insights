...
\begin{enumerate}
    ...
    we were having, and dicuss what our overall mission is. Almost more importantly though, working on this document (and problem statement and goals)
    was a sort of dry run for future deliverables. As we worked on this doc, we were able to put our plans of how to work together to the test. We found 
    that our git workflow needed a couple refinements and clarifications. For example, we needed to create more descriptive pull request titles and descriptions
    so that reviewers know what they are looking to review before approving.
    ...
    and it never really gets finished.
    ...
    We have to be careful that we don't let the lovely green check mark of passing all the tests, replace through code review. When people are pressed for time, it's
    ...
    we are using the git issues and pull request approach.
\end{enumerate}
