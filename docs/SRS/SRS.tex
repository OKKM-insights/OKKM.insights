...
\begin{itemize}
  ...
  \item \textbf{Fit Criterion:} After logging in and after the initiation of a service request, customers can request the system locate images from external providers by providing geographic coordinates.
\end{itemize}
\subsubsection*{FR8}
\begin{itemize}
