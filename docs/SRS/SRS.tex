...
\subsubsection*{PUC 2 - Customer Log In}
...
\subsubsection*{PUC 3 - Update User Information}
\textbf{Primary Actors:} Labelers, Customers\\ 
...
\subsubsection*{PUC 4 - Annotate Satellite Images}
\textbf{Primary Actors:} Labelers\\ 
...
\subsubsection*{PUC 5 - Segment Annotation}
\textbf{Primary Actors:} Labelers\\ 
\textbf{Precondition:} Labeler has logged in\\
\textbf{Trigger:} Labeler selects a listed project\\
\textbf{Success Scenario:}
...
\subsubsection*{PUC 6 - Bounding Box Annotation}
\textbf{Primary Actors:} Labelers\\ 
\textbf{Precondition:} Labeler has logged in\\
\textbf{Trigger:} Labeler selects a listed project\\
\textbf{Success Scenario:}
...
\subsubsection*{PUC 7 - Classification}
\textbf{Primary Actors:} Labelers\\ 
\textbf{Precondition:} Labeler has logged in\\
\textbf{Trigger:} Labeler selects a listed project\\
\textbf{Success Scenario:}
...
\subsubsection*{PUC 9 - View Image Insights}
\textbf{Primary Actors:} Customers\\
...
\subsubsection*{PUC 10 - Export Results}
\textbf{Primary Actors:} Customers\\
...
\subsubsection*{PUC 11 - Request Image Analysis}
\textbf{Primary Actors:} Customers\\
...
\subsubsection*{PUC 12 - Upload Satellite Images}
\textbf{Primary Actors:} Customers\\
...
\subsubsection*{PUC 13 - Request Satellite Images}
\textbf{Primary Actors:} Customers\\
...
\subsubsection*{PUC 14 - Process Payment}
\textbf{Primary Actors:} Customers\\
\textbf{Secondary Actor:} Financial Institution\\
\textbf{Precondition:} Customer has logged in and has created a new project request\\
